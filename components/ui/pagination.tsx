...
const Pagination = ({ className, ...props }: React.ComponentProps<'nav'>) => (
  <nav
    ...
    className={cn('mx-auto flex w-full justify-center m-8', className)}
    {...props}
  />
);
...
const PaginationPrevious = ({
  ...
  <PaginationLink
    ...
    size="lg"
    className={cn('gap-1 pl-2.5 hover:bg-sky-100', className)}
    {...props}
  >
...
const PaginationNext = ({
  ...
  <PaginationLink
    ...
    size="lg"
    className={cn('gap-1 pr-2.5 hover:bg-sky-100', className)}
    {...props}
  >
